...
const boot = async () => {
  ...
  // No silent identity probe. v0.3's design requires explicit consent
  // per capsule via the passkey-authenticate contract (see
  // pages/Landing.jsx — Sign in with passkey button). The runtime
  // intentionally hides the user's DID from /api/session and doesn't
  // expose it through any silent route; that's a security feature, not
  // a bug. Removing the previous [hey-adopt] block keeps Hey aligned
